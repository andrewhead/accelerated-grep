...
extern size_t EGexecute (char *, size_t, size_t *, char const *, bool last);

/* kwsearch.c */
extern void Fcompile (char const *, size_t);
extern size_t Fexecute (char *, size_t, size_t *, char const *, bool last);

/* pcresearch.c */
extern void Pcompile (char const *, size_t);
extern size_t Pexecute (char *, size_t, size_t *, char const *, bool last);
